...
export async function POST(req:Request){
 ...
 if(review.title.length<8)failures.push("title");if(review.summary.length<20)failures.push("summary");if(review.body.length<120)failures.push("body");if(review.confidence<0.75)failures.push("confidence");
