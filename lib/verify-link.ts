...
function blockedAddress(address:string){
  ...
  if(a==="127.0.0.1"||a==="0.0.0.0"||a==="::1"||a.startsWith("::ffff:127.")||a.startsWith("::ffff:10.")||a.startsWith("::ffff:192.168.")||a.startsWith("::ffff:169.254.")||a.startsWith("10.")||a.startsWith("192.168.")||a.startsWith("169.254."))return true;
